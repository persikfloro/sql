...
# Решение
Подготовлены:
* [docker-compose.yml](https://github.com/persikfloro/sql/blob/main/docker-compose.yml)
* [schema.sql](https://github.com/persikfloro/sql/blob/main/schema/schema.sql)
* [проект Gradle c кодом ваших автотестов](https://github.com/persikfloro/sql/tree/main/src/test/java/ru/netology)
